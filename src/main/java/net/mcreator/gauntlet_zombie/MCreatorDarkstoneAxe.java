...
public class MCreatorDarkstoneAxe extends Elementsgauntlet_zombie.ModElement {
	@GameRegistry.ObjectHolder("gauntlet_zombie:darkstoneaxe")
	public static final Item block = null;

	public MCreatorDarkstoneAxe(Elementsgauntlet_zombie instance) {
		super(instance, 52);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("darkstoneaxe").setRegistryName("darkstoneaxe").setCreativeTab(CreativeTabs.TOOLS));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("gauntlet_zombie:darkstoneaxe", "inventory"));
	}
