...
public class MCreatorAntimatterIslands extends Elementsgauntlet_zombie.ModElement {
	@GameRegistry.ObjectHolder("gauntlet_zombie:antimatterislands")
	public static final BiomeGenCustom biome = null;

	public MCreatorAntimatterIslands(Elementsgauntlet_zombie instance) {
		super(instance, 17);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Anti-matter Islands").setRainfall(0F).setBaseHeight(0.1F).setWaterColor(-16777216)
					.setHeightVariation(0.5F).setTemperature(0.5F));
			setRegistryName("antimatterislands");
