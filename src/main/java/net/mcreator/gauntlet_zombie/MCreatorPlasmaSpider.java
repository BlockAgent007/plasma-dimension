...
public class MCreatorPlasmaSpider extends Elementsgauntlet_zombie.ModElement {
	public static final int ENTITYID = 3;
	public static final int ENTITYID_RANGED = 4;

	public MCreatorPlasmaSpider(Elementsgauntlet_zombie instance) {
		super(instance, 2);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("gauntlet_zombie", "plasmaspider"), ENTITYID).name("plasmaspider").tracker(100, 1, true)
				.egg(-14079703, -8847237).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelSpider(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("gauntlet_zombie:textures/spider.png");
				}
			};
		});
	}
	...
	public static class EntityCustom extends EntityMob {
		public EntityCustom(World world) {
			...
			this.tasks.addTask(4, new EntityAIAttackMelee(this, 9999, true));
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				MCreatorPlasmaSpiderEntityDies.executeProcedure($_dependencies);
			}
		}
		...
		public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
			...
			Entity entity = this;
			{
				...
				MCreatorPlasmaSpiderOnInitialEntitySpawn.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
				MCreatorPlasmaSpiderEffectSpawn.executeProcedure($_dependencies);
			}
		}
