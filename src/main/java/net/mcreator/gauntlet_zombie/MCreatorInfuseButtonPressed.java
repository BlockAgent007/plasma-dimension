...
public class MCreatorInfuseButtonPressed extends Elementsgauntlet_zombie.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((new Object() {
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "plasmaFuel")) >= 10))) {
			{
			...
			}
			{
				...
				if (inv != null && (inv instanceof TileEntityLockableLoot))
					((TileEntityLockableLoot) inv).setInventorySlotContents((int) (2), new ItemStack(MCreatorPlasmaIngot.block,
							(int) ((1 + (new Object() {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(MCreatorPlasmaHoe.block, (int) (1)).getItem())) {
			if ((((new Object() {
				public double getValue(BlockPos pos, String tag) {
					TileEntity tileEntity = world.getTileEntity(pos);
					if (tileEntity != null)
			...
			}.getValue(new BlockPos((int) x, (int) y, (int) z), "plasmaFuel")) + ((new Object() {
				public ItemStack getItemStack(BlockPos pos, int sltid) {
					TileEntity inv = world.getTileEntity(pos);
					if (inv instanceof TileEntityLockableLoot)
						return ((TileEntityLockableLoot) inv).getStackInSlot(sltid);
			...
			}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getTagCompound().getDouble("plasmaFuel") : -1)) >= 100)) {
				{
					TileEntity tileEntity = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
					if (tileEntity != null)
						tileEntity.getTileData().setDouble("plasmaFuel", ((new Object() {
						...
						}.getValue(new BlockPos((int) x, (int) y, (int) z), "plasmaFuel")) - (100 - ((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								TileEntity inv = world.getTileEntity(pos);
								if (inv instanceof TileEntityLockableLoot)
									return ((TileEntityLockableLoot) inv).getStackInSlot(sltid);
						...
						}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getTagCompound().getDouble("plasmaFuel") : -1))));
				}
				{
					...
					_stack.getTagCompound().setDouble("plasmaFuel", 100);
				}
			}
		}
	}
