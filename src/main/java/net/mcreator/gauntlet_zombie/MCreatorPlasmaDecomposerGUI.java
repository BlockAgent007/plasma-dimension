...
public class MCreatorPlasmaDecomposerGUI extends Elementsgauntlet_zombie.ModElement {
	public static int GUIID = 2;
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;

	public MCreatorPlasmaDecomposerGUI(Elementsgauntlet_zombie instance) {
		super(instance, 106);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorPlasmaDecomposer.TileEntityCustom)
				inherited = (IInventory) ent;
			else
				inherited = new InventoryBasic("", true, 9);
			this.addSlotToContainer(new Slot(inherited, 0, 35, 39) {
			});
			this.addSlotToContainer(new Slot(inherited, 1, 125, 57) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(Items.BOOK, (int) (1)).getItem() == stack.getItem());
				}
			});
			this.addSlotToContainer(new Slot(inherited, 2, 125, 39) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			});
			this.addSlotToContainer(new Slot(inherited, 3, 125, 21) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("gauntlet_zombie:textures/plasmadecomposergui.png");
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Plasma Decomposer", 5, 5, -13421773);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 49, this.guiTop + 59, 70, 20, "Uncraft"));
		}
