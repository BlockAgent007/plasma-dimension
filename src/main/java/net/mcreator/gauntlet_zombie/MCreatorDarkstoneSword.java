...
public class MCreatorDarkstoneSword extends Elementsgauntlet_zombie.ModElement {
	@GameRegistry.ObjectHolder("gauntlet_zombie:darkstonesword")
	public static final Item block = null;

	public MCreatorDarkstoneSword(Elementsgauntlet_zombie instance) {
		super(instance, 54);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("darkstonesword").setRegistryName("darkstonesword").setCreativeTab(CreativeTabs.COMBAT));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("gauntlet_zombie:darkstonesword", "inventory"));
	}
}
