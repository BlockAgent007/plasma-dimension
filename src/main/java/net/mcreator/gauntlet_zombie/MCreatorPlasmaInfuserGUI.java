...
public class MCreatorPlasmaInfuserGUI extends Elementsgauntlet_zombie.ModElement {
	public static int GUIID = 1;
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;

	public MCreatorPlasmaInfuserGUI(Elementsgauntlet_zombie instance) {
		super(instance, 75);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorPlasmaInfuser.TileEntityCustom)
				inherited = (IInventory) ent;
			else
				inherited = new InventoryBasic("", true, 9);
			this.addSlotToContainer(new Slot(inherited, 0, 141, 53) {
			});
			this.addSlotToContainer(new Slot(inherited, 1, 41, 29) {
			});
			this.addSlotToContainer(new Slot(inherited, 2, 120, 29) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				gauntlet_zombie.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("gauntlet_zombie:textures/plasmainfusergui.png");
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Plasma Infuser", 4, 4, -13421773);
			this.fontRenderer.drawString("Plasma Remaining:" + (gauntlet_zombieVariables.PlasmaAmount) + "l", 26, 71, -13421773);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 57, this.guiTop + 50, 60, 20, "Infuse"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			gauntlet_zombie.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				MCreatorInfuseButtonPressed.executeProcedure($_dependencies);
			}
		}
	}
