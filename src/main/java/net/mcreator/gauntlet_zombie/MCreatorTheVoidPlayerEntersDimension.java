...
public class MCreatorTheVoidPlayerEntersDimension extends Elementsgauntlet_zombie.ModElement {
	public MCreatorTheVoidPlayerEntersDimension(Elementsgauntlet_zombie instance) {
		super(instance, 33);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (!entity.world.isRemote && entity.world.getMinecraftServer() != null) {
			...
			}, "entitydata @s{Attributes:[{Name:\"generic.attackDamage\",Base:-5}]}");
		}
	}
}
